 ...
 // active section within Warnings book
  ...
  function renderChapter(ch, results, chIdx, summaryText) {
    ...
    if (summaryText) {
      ...
      html += '<button class="action-btn quote2-btn" title="Quote"><svg width="18" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></button>';
  ...
  function buildMediaBar(opts) {
    ...
    if (opts.avatar && opts.avatar.id !== 'None') {
      ...
      html += '<button class="action-btn quote2-btn" title="Quote"><svg width="16" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></button>';
